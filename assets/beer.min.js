export default (() => {
  ...
  function T(t) {
    const n = t;
    k(n, "number") && !n.value && (n.value = ""),
      n.placeholder || (n.placeholder = " "),
      t.getAttribute("data-ui") && q(t, null);
  }
  function tt(t) {
  ...
  function lt(t, n) {
    ...
    if (e)
      for (let r = 0; r < e.children.length; r++)
        d(e.children[r], "page") && u(e.children[r], "active");
    v(n, "active");
  }
  function V(t, n, e) {
    N && clearTimeout(N),
  ...
  function gt() {
    ...
    for (let c = 0; c < i.length; c++)
      (l.light += i[c] + ":" + e.getPropertyValue(i[c]) + ";"),
        (l.dark += i[c] + ":" + r.getPropertyValue(i[c]) + ";");
    ...
    return t.light && t.dark
      ...
      : globalThis.materialDynamicColors(t).then((e) => {
          ...
          return (
            (l.light = r(e.light)),
            (l.dark = r(e.dark)),
            document.body.setAttribute("style", l[n]),
            l
          );
        });
  }
  ...
  function pt() {
    P ||
      ((P = new MutationObserver(Z)),
      P.observe(document.body, {
        attributes: !0,
        attributeFilter: ["value", "max", "min"],
        childList: !0,
        subtree: !0,
      }),
      Z());
